...
import { Home, FileEdit, CreditCard, DollarSign, Wallet } from 'lucide-react';

const navItems = [
  { name: 'Dashboard', href: '/mentor/dashboard', icon: Home },
  { name: 'My Services', href: '/mentor/dashboard/services', icon: FileEdit },
  { name: 'Bookings', href: '/mentor/dashboard/bookings', icon: CreditCard },
  { name: 'Payments', href: '/mentor/dashboard/payments', icon: DollarSign },
  { name: 'Wallet', href: '/mentor/dashboard/wallet', icon: Wallet },
];
